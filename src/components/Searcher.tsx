...
function Searcher(props: Props):JSX.Element{
  ...
  const onSearchChange: ChangeEventHandler<HTMLInputElement | HTMLTextAreaElement> = (event):void =>{
  ...
  return (
      <Stack direction="row" alignItems="center" justifyContent="center" sx={{
          ...
          <SercherTextField id="Github User" type='text' label="Github User" variant="filled" InputProps={{
              endAdornment: (
                <IconButton id='search-icon' size='small' onClick={handleSendSearch}>
                  <SearchIcon sx={{
                    fontSize: "35px",
                    color: "rgba(255, 255, 255, 0.7)",
                  }}/>
